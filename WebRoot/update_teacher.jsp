...
<body class="fixed-top">
   ...
   <div id="container" class="row-fluid">
      ...
      <div id="main-content">
                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i>修改教师信息</h4>
                            <span class="tools">
		...
		<form name="updateForm"method="post" action="AdminAction!update_teacher" onSubmit="return mycheck()">
		<table class="ta" width="100px">	
		<tr >
			<td>教工号</td>
			<td><input type="text" id="teacherno" name="teacherno" value="${sessionScope.teacher.teacherno }"/></td>
		</tr>
		<input type="hidden" name="teacherId" value="${sessionScope.teacher.id }"/>
		<tr >
			<td>姓名</td>
			<td><input type="text" id="teachername" name="teachername" value="${sessionScope.teacher.teachername }"/></td>
		</tr>
		<tr >
			<td>密码</td>
		<td><input type="text" id="password" name="password" value="${sessionScope.teacher.password }"/>
		...
		<tr >
			<td>职称</td>
			<td><input type="text" id="profession" name="profession" value="${sessionScope.teacher.profession }"/></td>
		</tr>
		<tr >
			<td>电话</td>
			<td><input type="text" id="phone"name="phone" value="${sessionScope.teacher.phone }"/></td>
		</tr>
		<tr >
			<td>身份</td>
			<td>
			<label><input type="radio" name="identity" value="竞赛负责人"/>竞赛负责人</label>
			<label><input type="radio" name="identity" value="指导教师"/>指导教师&nbsp;&nbsp;&nbsp;</label>
			</td>
		</tr>		
		<tr>
  ...
  function mycheck(){
   if(isNull(updateForm.teacherno.value)){  
   alert("请输入教工号！"); 
   return false;
   }
   if(updateForm.teacherno.value.length>15){  
   alert("教工号不得超过15位！"); 
   return false;
   }
   if(isNull(updateForm.teachername.value)){  
   alert("请输入姓名！"); 
   return false;
   }
   if(isNull(updateForm.password.value)){  
   alert("请输入密码！"); 
   return false;
   }
   if(updateForm.password.value.length>15){  
   alert("密码不得超过15位！"); 
   return false;
   }
   if(isNull(updateForm.profession.value)){  
   alert("请输入职称！"); 
   return false;
   }
   if(isNull(updateForm.phone.value)){  
   alert("请输入电话！"); 
   }  
}
