              ...
              <li class="sub-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="QueryAction!contestantList">管理选手信息</a></li>
                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i>选手列表</h4>
                            <span class="tools">
                         ...
                         <div class="widget-body">
                             <div>
                                 <div class="clearfix">
                                     <div class="btn-group">
    <input type="button" class="btn green" value="添加新选手╋"onclick="window.location.href='contest_info.jsp'">                                                                      
                                     </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     <tbody>
   									<c:forEach items="${sessionScope.contestantList }" var="cta" varStatus="status">
									<tr class="">
