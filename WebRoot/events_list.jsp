                   ...
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown">
                           <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                               ...
                               <span class="username">${sessionScope.teacher.teachername}</span>
                               <b class="caret"></b>
                           </a>
                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i>赛事列表</h4>
                            <span class="tools">
                         ...
                         <div class="widget-body">
                             <div>
                                 <div class="clearfix">
                                     <div class="btn-group">
    <input type="button" class="btn green" value="添加新赛事╋"onclick="window.location.href='contest_info.jsp'">                                                                      
                                     </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     <tbody>
   									<c:forEach items="${sessionScope.eventsList }" var="eve" varStatus="status">
									<tr class="">
									<td><c:out value="${status.count}"/> </td>
									<td>${eve.contestname }</td>
									<td>${eve.scope }</td>
									<td>${eve.organizer}</td>
                                    <td><a class="" href="QueryAction!queryEvents?event_id=${eve.id}">Edit</a></td>
                                    <td><a class="" href="TeacherAction!delete_event?event_id=${eve.id}" onclick="return confirm('确认删除？');">Delete</a></td>									
									</tr>
									</c:forEach>	                                      
                                    </tbody>
                                 </table>
