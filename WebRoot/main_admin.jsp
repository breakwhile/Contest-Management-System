            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-orange">
                        <a data-original-title="" href="QueryAction!teacherList">
                            <i class="icon-user"></i>
                            <div class="info">321</div>
                            <div class="status">教师管理</div>
                        </a>
                    </div>
                    <div class="metro-nav-block nav-olive">
                        <a data-original-title="" href="result_contest.jsp">
                            <i class="icon-tags"></i>
                            <div class="info">+970</div>
                            <div class="status">成绩报表</div>
                        </a>
                    </div>
                    <div class="metro-nav-block nav-block-yellow">
                        <a data-original-title="" href="QueryAction!applyPowerList">
                            <i class="icon-comments-alt"></i>
                            <div class="info">49</div>
                            <div class="status">负责人申请</div>
                        </a>
                    </div>
                    <div class="metro-nav-block nav-block-green double">
                        <a data-original-title="" href="QueryAction!fundList">
                            <i class="icon-eye-open"></i>
                            <div class="info">+897</div>
                            <div class="status">经费使用明细</div>
                        </a>
                    </div>
                    ...
                    <div class="widget ">
                        ...
                        <div class="widget-body">
                            <div class="text-center">
                                <canvas id="pie_canvas" height="400" width="800"></canvas>
                            </div>
                        </div>
                    </div>
                    <!-- END CHART PORTLET-->
