...
<head>
   <meta charset="utf-8" />
   <title>Metro风格响应式后台管理系统模板MetroAdmin 空白页面 - JS代码网</title>
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu active">
                  ...
                  <ul class="sub">
                      <li class="active"><a class="" href="apply_fund.jsp">经费申请</a></li>
         ...
         <div class="container-fluid">
            ...
            <!-- END PAGE CONTENT-->
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>提交申请</h4>
                            <span class="tools">
                            <a href="javascript:;" class="icon-chevron-down"></a>
                            <a href="javascript:;" class="icon-remove"></a>
                            </span>
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="TeacherAction!apply_fund" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label">数额</label>
                                <div class="controls">
                                    <div class="input-prepend input-append">
                                     <input id="applyFund" name="applyFund" type="text" placeholder="请在这里填入申请数额"/>
                                    </div>
                                </div>
                            </div>
