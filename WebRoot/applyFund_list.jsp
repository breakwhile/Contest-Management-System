             ...
             <ul class="sidebar-menu">
              ...
              <li class="sub-menu active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="QueryAction!applyFundList">经费申请</a></li>
                         ...
                         <div class="widget-body">
                             <div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     <tbody>
   									<c:forEach items="${sessionScope.applyFundList }" var="app" varStatus="status">
									<tr class="">
									<td><c:out value="${status.count}"/> </td>
									<td>${app.plus }</td>
									<td>${app.detail }</td>
                                    <td><a class="" href="AdminAction!ratify?teacher_id=${app.detail}&apply_id=${app.id}">批准</a></td>
                                    <td><a class="" href="AdminAction!rebut?apply_id=${app.id}">驳回</a></td>									
									</tr>
									</c:forEach>	                                      
                                    </tbody>
                                 </table>
