...
<body class="fixed-top">
   ...
   <div id="container" class="row-fluid">
              ...
              <li class="sub-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="queryAction!eventsList">管理赛事信息</a></li>
      ...
      <div id="main-content">
                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i>修改赛事信息</h4>
                            <span class="tools">
		...
		<input class="btn green" value="back" type=button onclick="javascript:window.history.back();">
		<form name="updateForm"method="post" action="TeacherAction!update_event" onSubmit="return mycheck()">
		<table class="ta" width="100px">	
		<tr >
			<td>赛事名称</td>
			<td><input type="text" id="eventName" name="eventName" value="${sessionScope.event.contestname }"/></td>
		</tr>
		<input type="hidden" name="eventId" value="${sessionScope.event.id }"/>
		<tr >
			<td>赛事级别</td>
			<td>
			<label><input type="radio" name="eventScope" value="校级"/>校级</label>
			<label><input type="radio" name="eventScope" value="市级"/>市级</label>
			<label><input type="radio" name="eventScope" value="省级"/>省级</label>						
			<label><input type="radio" name="eventScope" value="国家级"/>国家级</label>
			</td>
		</tr>	
		<tr >
			<td>主办方</td>
			<td><input type="text" id="eventOrg" name="eventOrg" value="${sessionScope.event.organizer }"/></td>
		</tr>		
		<tr>
			<td colspan="2"><input style="color:blue" type="submit"  value="提交" class="buStyle" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" style="color:blue" value="重置" class="buStyle"/></td>
		</tr>
		</table>
		</form>
                             </div>
  ...
  function mycheck(){
   if(isNull(updateForm.eventName.value)){  
   alert("请输入竞赛名称！"); 
   return false;
   }
   if(isNull(updateForm.eventOrg.value)){  
   alert("请输入主办方！"); 
   return false;
   } 
}
