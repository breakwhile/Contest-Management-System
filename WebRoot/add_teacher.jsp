...
<body class="fixed-top">
   ...
   <div id="container" class="row-fluid">
      ...
      <div id="main-content">
                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i>添加新教师</h4>
                            <span class="tools">
		...
		<form name="addForm" method="post" action="AdminAction!add_teacher" onSubmit="return mycheck()">
		<table class="ta" width="100px">	
		<tr >
			<td>教工号</td>
			<td><input type="text" id="add_teacherno" name="add_teacherno"/></td>
		</tr>
		<tr >
			<td>姓名</td>
			<td><input type="text" id="add_teachername" name="add_teachername"/></td>
		</tr>
		<tr >
			<td>密码</td>
		...
		<tr >
			<td>职称</td>
			<td><input type="text" id="add_profession" name="add_profession" /></td>
		</tr>
		<tr >
			<td>电话</td>
		...
		<tr >
			<td>身份</td>
			<td>
			<label><input type="radio" name="add_identity" value="竞赛负责人" checked/>竞赛负责人</label>
			<label><input type="radio" name="add_identity" value="指导教师"/>指导教师&nbsp;&nbsp;&nbsp;</label>
			</td>
		</tr>		
		<tr>
  ...
  function mycheck(){
   if(isNull(addForm.add_teacherno.value)){  
   alert("请输入教工号！"); 
   return false;
   }
   if(addForm.add_teacherno.value.length>15){  
   alert("教工号不得超过15位！"); 
   return false;
   }
   if(isNull(addForm.add_teachername.value)){  
   alert("请输入姓名！"); 
   return false;
   }
   if(isNull(addForm.add_password.value)){  
   alert("请输入密码！"); 
   return false;
   }
   if(addForm.add_password.value.length>15){  
   alert("密码不得超过15位！"); 
   return false;
   }
   if(isNull(addForm.add_profession.value)){  
   alert("请输入职称！"); 
   return false;
   }
   if(isNull(addForm.add_phone.value)){  
   alert("请输入电话！"); 
   }  
}
