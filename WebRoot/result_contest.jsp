          ...
          <div id="sidebar" class="nav-collapse collapse">
             ...
             <ul class="sidebar-menu">
              ...
              <li class="sub-menu active">
                  ...
                  <ul class="sub">
                      <li class="active"><a class="" href="result_contest.jsp">成绩报表</a></li>
...
<img src="jfreechart/JFreeChartAwardAction.action" width="900" height="800">    
<br/><br/><br/>
<img src="jfreechart/JFreeChartScopeAction.action" width="900" height="800">             
                         </div>                        
                     </div>
