             ...
             <ul class="sidebar-menu">
              ...
              <li class="sub-menu active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="QueryAction!fundList">经费使用明细</a></li>
                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i>已使用：<font color="blue">${sessionScope.spend}￥&nbsp;&nbsp;&nbsp;&nbsp;</font> 总计：<font color="black">${sessionScope.total}￥</font></h4>
                            <span class="tools">
                         ...
                         <div class="widget-body">
                             <div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     <tbody>
   									<c:forEach items="${sessionScope.fundList }" var="fList" varStatus="status">
									<tr class="">
									<td><c:out value="${status.count}"/> </td>
									<td>${fList.note }</td>
									<td>${fList.spend }</td>
                                    <td><a class="" href="AdminAction!delete_fund?fund_id=${fList.id}">删除</a></td>								
									</tr>
									</c:forEach>	                                      
                                    </tbody>
                                 </table>
