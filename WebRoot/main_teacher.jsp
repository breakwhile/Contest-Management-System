...
<body class="fixed-top">
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="apply_fund.jsp">经费申请</a></li>
                      <li><a class="" href="apply_power.jsp">申请成为竞赛负责人</a></li>
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      ...
                      <li><a class="" href="QueryAction!contestInfoList">新增选手/赛事/成绩</a></li>
            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-orange">
                        <a data-original-title="" href="QueryAction!contestInfoList">
                            <i class="icon-user"></i>
                            <div class="info">321</div>
                            <div class="status">新增竞赛信息</div>
                        </a>
                    </div>
                    <div class="metro-nav-block nav-olive">
                        <a data-original-title="" href="TeacherAction!query_fund">
                            <i class="icon-tags"></i>
                            <div class="info">+970</div>
                            <div class="status">新增经费支出</div>
                        </a>
                    </div>
                    <div class="metro-nav-block nav-block-yellow">
                        <a data-original-title="" href="QueryAction!eventsList">
                            <i class="icon-comments-alt"></i>
                            <div class="info">49</div>
                            <div class="status">管理赛事信息</div>
                        </a>
                    </div>
                    <div class="metro-nav-block nav-block-green double">
                        <a data-original-title="" href="QueryAction!contestantList">
                            <i class="icon-eye-open"></i>
                            <div class="info">+897</div>
                            <div class="status">管理选手信息</div>
                        </a>
                    </div>
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-light-purple">
                        <a data-original-title="" href="apply_fund.jsp">
                            <i class="icon-shopping-cart"></i>
                            <div class="info">29</div>
                            <div class="status">经费申请</div>
                        </a>
                    </div>
                    <div class="metro-nav-block nav-light-blue double">
                        <a data-original-title="" href="apply_power.jsp">
                            <i class="icon-tasks"></i>
                            <div class="info">$37624</div>
                            <div class="status">申请成为竞赛负责人</div>
                        </a>
                    </div>
            ...
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <div class="widget ">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>获奖情况</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <div class="text-center">
                                <canvas id="pie_canvas" height="400" width="800"></canvas>"300" width="400"></canvas>
                            </div>
                        </div>
                    </div>
                    <!-- END CHART PORTLET-->
                ...
                <div class="span6">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"> </i>历年参加人数</h4>
                            <span class="tools">
                                <a href="javascript:;" class="icon-chevron-down"></a>
                                <a href="javascript:;" class="icon-remove"></a>
                            </span>
                        ...
                        <div class="widget-body">
                            <div class="text-center">
                                <img src="img/zhexian.png"  height="400" width="800" />
                            </div>
                        </div>
                    </div>
                    <!-- END CHART PORTLET-->
   ...
   <script src="assets/chart-master/MyChart.js"></script>
   ...
   <script src="js/home-chartjs.js"></script>
	...
	window.onload = function() {
		...
		var seriesData = [{name:"特等奖", value:30, color:"RGBA(255,0,0,1)"},
		              {name:"一等奖", value:100, color:"RGBA(255,255,0,1)"},
		              {name:"二等奖", value:90, color:"RGBA(255,0,255,1)"},
		              {name:"三等奖", value:100, color:"RGBA(0,255,255,1)"},
		              {name:"优秀奖", value:80, color:"RGBA(0,127,255,1)"}]
		var config = {
				width : 800, 
				height: 400,
				series: seriesData,
