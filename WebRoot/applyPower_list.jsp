             ...
             <ul class="sidebar-menu">
              ...
              <li class="sub-menu active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="QueryAction!applyPowerList">负责人申请</a></li>
                         ...
                         <div class="widget-body">
                             <div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     <tbody>
   									<c:forEach items="${sessionScope.applyPowerList }" var="app" varStatus="status">
									<tr class="">
									<td><c:out value="${status.count}"/> </td>
									<td>${app.detail }</td>
									<td>${app.plus }</td>
									<td>${app.applyname}</td>
                                    <td><a class="" href="AdminAction!ratify?apply_id=${app.id}&apply_name=${app.applyname}&apply_detail=${app.detail}">批准</a></td>
                                    <td><a class="" href="AdminAction!rebut?apply_id=${app.id}&apply_name=${app.applyname}">驳回</a></td>									
									</tr>
									</c:forEach>	                                      
                                    </tbody>
                                 </table>
